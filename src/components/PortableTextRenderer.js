...
const components = {
  block: {
    h2: ({ children }) => (
      <h2 className="mt-10 text-3xl font-semibold text-[#2B2723]">{children}</h2>
    ),
    h3: ({ children }) => (
      <h3 className="mt-8 text-2xl font-semibold text-[#2B2723]">{children}</h3>
    ),
    h4: ({ children }) => (
      <h4 className="mt-6 text-xl font-semibold text-[#2B2723]">{children}</h4>
    ),
    normal: ({ children }) => (
  ...
  marks: {
    link: ({ children, value }) => {
      ...
      return (
        <Link
          ...
          className="underline decoration-[#8C7866] underline-offset-4 transition hover:text-[#2B2723]"
        >
          {children}
        </Link>
      );
    ...
    em: ({ children }) => <em className="italic text-[#2B2723]">{children}</em>,
  },
};
